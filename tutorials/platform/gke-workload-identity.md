...
Having deployed Workload Identity Delegate, you can also do keyless signing of your container images using Google Application Credentials using [cosign](https://sigstore.dev/cosign/overview).